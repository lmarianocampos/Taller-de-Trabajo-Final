...
\begin{itemize}
\item Diseño y construcción de  un sistema de control que permita al usuario establecer un caudal de agua por medio de una aplicación externa.
...
\item Desarrollar un firmware que sea escalable que permita la comunicación con otras celdas primarias dispuestas en otras compuertas. 
\end{itemize}
